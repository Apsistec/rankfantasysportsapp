...
export const Faqs: FAQ[] = [
    { title: 'How does Rank Fantasy Sports Operate? Great Question', info: 'Our mission is to provide our members the best information possible for our members to use!' },
    { title: 'How does Rank Fantasy Sports Operate? Great Question', info: 'We want you to make the best decisions possible for your team\'s success' },
    { title: 'How does Rank Fantasy Sports Operate? Great Question', info: 'Initially we will also provide excellent data for our members to use in fantasy lineups for the NBA, Tennis and Golf' },
    { title: 'How does Rank Fantasy Sports Operate? Great Question', info: 'We are striving to be "the go to site" for those that love daily and seasonal fantasy sports!' },
    ...
    // // tslint:disable-next-line: max-line-length
    // { info: 'The Tennis, Golf & Football reports provided by the data analysts at Rank Fantasy $ports are rapidly becoming some of the most sought after Daily Fantasy Sports (DFS) supplemental resources to hit the marketWhy is that?' },
    ...
    // { info: 'As I am sure you will agree, we feel that Daily Fantasy Sports (DFS) enhances the enjoyment of watching and keeping track of the games in each sport all season long' },
    ...
    // { info: 'Also, RF$ delivers their data services to subscribers using the latest cutting edge software' },
    // { info: 'This progressive web app (PWA) is continuously developed with a mobile first mindset providing subscribers with the fastest loading pages possible' },
