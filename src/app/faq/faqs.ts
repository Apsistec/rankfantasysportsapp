...
export const Faqs: FAQ[] = [
    ...
    { title: 'What is RankFantasySports.com?', info: 'RankFantasySports.com(RF$) is a progressive web app designed dedicated to Daily Fantasy Sports(DFS) players. The sports data-analysts at RF$ carefully calculate their sports data models and DFS platform cheat sheets, and have successfully done so over the years. Their attention to detail and unique approach to data compilation has evolved over the years to become one of the key components in helping everyone at RF$ to win consistently.  Now, those same sports data analysts provide their expertise as a service to help others, like you, to make more informed winning lineups in less time, and ultimately to help DFS players such as yourself win more & more often!' },
    // tslint:disable-next-line: max-line-length
