...
const appRoutes: Routes = [
  ...
  { path: 'login', loadChildren: './auth/login/login.module#LoginPageModule', canActivate: [InnerRoutesGuard] },
  { path: 'sign-in', redirectTo: 'login', pathMatch: 'full' },
  { path: 'register', loadChildren: './auth/register/register.module#RegisterPageModule', canActivate: [InnerRoutesGuard] },
  { path: 'forgot', loadChildren: './auth/forgot-password/forgot-password.module#ForgotPasswordPageModule', canActivate: [InnerRoutesGuard] },
  ...
  { path: 'categories', loadChildren: './sports-categories/sports-categories.module#SportsCategoriesPageModule', canActivate: [AuthGuard] },
  { path: 'categories/:id', component: SportsCategoriesDetailComponent },
  { path: 'tables/:id', component: SportsTablesComponent, canActivate: [PaidMemberGuard], },
