...
export const Faqs: FAQ[] = [
  {
    title: 'What is "Daily Fantasy Sports" also known as DFS?',
    info:
  ...
  {
    title: 'Where did Rank Fantasy $ports, the idea come from?',
    info:
